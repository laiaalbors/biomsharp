...
def test_france_pipeline(root_path):
    ...
    for _, dataset_opt in sorted(opt['datasets'].items()):
        if dataset_opt["type"] != "FranceBiomassDataset":
            raise ValueError(f"France evaluation can only work with FranceBiomassDataset!")
...
if __name__ == '__main__':
    ...
    test_france_pipeline(root_path)